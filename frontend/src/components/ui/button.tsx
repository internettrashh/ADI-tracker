...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-none text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary/10 text-primary hover:bg-primary/20 retro-glow border border-primary/50",
        destructive:
          "bg-destructive/10 text-destructive hover:bg-destructive/20 border border-destructive/50",
        outline:
          "border border-input/50 bg-background/50 hover:bg-accent/10 hover:text-accent retro-panel",
        secondary:
